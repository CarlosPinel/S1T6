...
public class Main {
	...
	public static void main(String[] args) {
		...
		Smartphone smartphone1 = new Smartphone("Google", "Pixel4a", 669222555);
		String mensaje1 = Generic.llamarGeneric(smartphone1);
		System.out.println(mensaje1);
		String mensaje2 = Generic.hacerFotosGeneric(smartphone1);
